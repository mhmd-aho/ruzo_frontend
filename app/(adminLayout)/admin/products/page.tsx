...
export default async function AdminProducts(){
    ...
    return (
        <div className="flex flex-col justify-center items-center ">
            ...
            <Link className="lg:px-4 lg:py-2 py-1 px-2 bg-primary text-white rounded-md flex items-center gap-2" href="/admin/products/add"><Plus fill="white"/>New Product</Link>
            </div>
